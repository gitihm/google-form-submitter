...
const post = () =>
	request.post(
        ...
        [null,2020539539,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,188243699,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,188243699,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,902884018,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1338186110,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1868234083,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,591247175,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,112673333,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,615918331,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,627761708,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,716553906,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1445650290,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1105754828,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,396770170,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1635940082,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1648325037,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1791028447,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,1825525569,["${rand() > 7 ? '5' : rand() > 7 ? '3' : '4'}"]
        ,0],
        [null,586596687,["${rand() > 7 ? 'Male (ผู้ชาย)' : 'Female (ผู้หญิง)'}"]
        ,0],
        [null,1558394379,["${
			rand() > 7
